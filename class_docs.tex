...
%  └────────────────────────┘
    ...
    \newcommand{\structure} {
        The nueral network structre is seen in the images below:
        \newFigure{media/multi-neuron.pdf}[Multi Neuron Network][0.5]
        \newFigure{media/single-layer-nueron.pdf}[Single Layer Nueron][0.5]
    } 

    \newcommand{\updating} {
        To solve for the minima using the gradient decent tequnique, the equation
