...
%  └────────────────────────┘
    ...
    \DeclareDocumentCommand{\structure}{} {
        The neural network structure is seen in the images below:
        \newFigure{media/multi-neuron.pdf}[Multi Neuron Network][0.5]
        \newFigure{media/single-layer-nueron.pdf}[Single Layer Neuron][0.5]
    } 

    \DeclareDocumentCommand{\updating}{} {
        To solve for the minim using the gradient decent technique, the equation
